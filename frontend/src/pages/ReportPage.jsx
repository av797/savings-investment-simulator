        ...
        <div>
          ...
          <div className="flex rounded-full overflow-hidden h-3">
            {data.goals.map((item, i) => {
              ...
              const colors = ['bg-emerald-400', 'bg-blue-400', 'bg-yellow-400', 'bg-red-400', 'bg-gray-400']
              return (
                <div
                  key={item.goal.id}
          ...
          <div className="flex flex-wrap gap-3 mt-2">
            {data.goals.map((item, i) => {
              const colors = ['text-emerald-400', 'text-blue-400', 'text-yellow-400', 'text-red-400', 'text-gray-400']
              return (
